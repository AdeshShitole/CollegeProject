...
public class CollegeController {
	...
	//I am creating some other restApi
	@GetMapping("salaryUnder30k/{salary}")
	public List<Staff> getStaffWhoseSalaryUnder30k(@PathVariable double salary) {
		return cs.getStaffWhoseSalaryUnder30k(salary);
	}
